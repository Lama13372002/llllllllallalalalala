...
const formSchema = z.object({
  ...
  contactMethod: z.enum(['telegram', 'whatsapp', 'call'], {
                      ...
                      <FormControl>
                        ...
                        >
                          <label
                            ...
                            className={`flex flex-col items-center space-y-2 border rounded-lg p-4 cursor-pointer hover:bg-slate-50 ${field.value === 'telegram' ? 'bg-slate-50 border-primary' : ''}`}
                            onClick={() => field.onChange('telegram')}
                          >
                            ...
                            <RadioGroupItem value="telegram" id="contact-telegram" className="sr-only" />
                          </label>

                          <label
                            htmlFor="contact-whatsapp"
                            className={`flex flex-col items-center space-y-2 border rounded-lg p-4 cursor-pointer hover:bg-slate-50 ${field.value === 'whatsapp' ? 'bg-slate-50 border-primary' : ''}`}
                          ...
                          <label
                            ...
                            className={`flex flex-col items-center space-y-2 border rounded-lg p-4 cursor-pointer hover:bg-slate-50 ${field.value === 'call' ? 'bg-slate-50 border-primary' : ''}`}
                            onClick={() => field.onChange('call')}
                          >
                            <Phone className="h-5 w-5 text-red-500" />
                            <span className="text-center">Звонок</span>
                            <RadioGroupItem value="call" id="contact-call" className="sr-only" />
                          </label>
                        </RadioGroup>
                      </FormControl>
                      <FormMessage />
