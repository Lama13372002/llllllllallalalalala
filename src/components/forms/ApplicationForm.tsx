                  ...
                  render={({ field }) => (
                    <FormItem className="space-y-3">
                      ...
                      <FormControl>
                        ...
                        >
                          <div className="flex flex-col items-center space-y-2 border rounded-lg p-4 hover:bg-slate-50 cursor-pointer">
                            ...
                            <FormLabel className="font-normal cursor-pointer text-center" htmlFor="contact-telegram">Telegram</FormLabel>
                          ...
                          <div className="flex flex-col items-center space-y-2 border rounded-lg p-4 hover:bg-slate-50 cursor-pointer">
                            ...
                            <FormLabel className="font-normal cursor-pointer text-center" htmlFor="contact-whatsapp">WhatsApp</FormLabel>
                            <RadioGroupItem value="whatsapp" id="contact-whatsapp" className="sr-only" />
                          </div>
                          <div className="flex flex-col items-center space-y-2 border rounded-lg p-4 hover:bg-slate-50 cursor-pointer">
                            <Phone className="h-5 w-5 text-red-500" />
                            <FormLabel className="font-normal cursor-pointer text-center" htmlFor="contact-call">Звонок</FormLabel>
