          ...
          >
            <div className="container mx-auto py-8 px-6 flex flex-col h-full">
              ...
              >
                ...
                <div className="bg-gray-50 dark:bg-gray-800/50 rounded-xl p-5 shadow-sm mb-6">
                  <h3 className="text-sm font-semibold text-gray-800 dark:text-gray-200 mb-3">Связаться с нами</h3>

                  <a
                    href={`tel:${settings.phone.replace(/\s+/g, '')}`}
                    className="flex items-center text-base font-medium text-gray-700 dark:text-gray-200 hover:text-primary dark:hover:text-primary transition-colors mb-4"
                  >
                  ...
                  <div className="flex items-center justify-between">
                    <a
                      ...
                      rel="noopener noreferrer"
                    >
                      <div className="w-10 h-10 bg-gradient-to-br from-pink-500 to-purple-600 rounded-full flex items-center justify-center mb-1 transform hover:scale-110 transition-transform">
                    ...
                    <a
                      ...
                      rel="noopener noreferrer"
                    >
                      <div className="w-10 h-10 bg-gradient-to-br from-blue-400 to-blue-600 rounded-full flex items-center justify-center mb-1 transform hover:scale-110 transition-transform">
                    ...
                    <a
                      ...
                      rel="noopener noreferrer"
                    >
                      <div className="w-10 h-10 bg-gradient-to-br from-green-500 to-green-600 rounded-full flex items-center justify-center mb-1 transform hover:scale-110 transition-transform">
                ...
                <Dialog>
                  <DialogTrigger asChild>
                    <Button
                      className="w-full py-6 rounded-xl btn-gradient text-white font-medium text-lg shadow-lg relative overflow-hidden group mb-4"
                      onClick={() => setIsMobileMenuOpen(false)}
                    >
